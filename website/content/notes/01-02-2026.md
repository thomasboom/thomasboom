...
I just opened a pull request on the Rust-based [Zed](https://zed.dev) editor, a massive open source project with over [74k stars on GitHub](https://github.com/zed-industries/zed). It changed the way I look at open source.
